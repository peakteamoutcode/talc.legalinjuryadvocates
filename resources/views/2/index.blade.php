...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <div>
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 visible-xs-block" style="padding:2% 2% 0 2%;"><img src="/2/sm/img/ja-logo.88f9ead28caf.png">
                        <div class="cta-question" style="margin-bottom:-25px;"><img src="/2/sm/img/ribbonOC3-sm2.8085f966f224.png" align="left"><h2 style="margin-top:10px;font-size: 20px; font-weight:100;line-height: 22px;c">Were you harmed by dangerous <span style="font-weight:bold;">talcum powder</span>?</h2>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5 visible-sm-block visible-md-block visible-lg-block" style="padding:2%;"><img src="/2/sm/img/ja-logo.88f9ead28caf.png">
                        <div class="cta-question"><img src="/2/sm/img/ribbonOC.b8a8c23ce608.png" align="left"><h2 style="margin-top:40px;font-size: 3em; font-weight:100;line-height: 1em;">Were you harmed by dangerous <span style=";font-weight:bold;">talcum powder</span>?<br></h2>
